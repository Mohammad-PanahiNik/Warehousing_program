...
class MainPage(tk.Frame,Tk):
    ...
    def create_widgets(self):
        ...
        self.hi_button = tk.Button(self, text="Go to Hello Page", command=self.go_to_hello_page)
        self.hi_button.pack(side="top")

    def go_to_hello_page(self):
        self.master.switch_page(HelloPage)
...
class HelloPage(tk.Frame):
    ...
    def create_widgets(self):
        self.hi_label = tk.Label(self, text="Hello World!")
        self.hi_label.pack(side="top")

        self.back_button = tk.Button(self, text="Go Back to Main Page", command=self.go_to_main_page)
        self.back_button.pack(side="bottom")

    def go_to_main_page(self):
        self.master.switch_page(MainPage)
